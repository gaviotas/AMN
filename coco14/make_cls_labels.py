...
if __name__ == '__main__':
    ...
    parser.add_argument("--coco14_root", default="../../../Dataset/VOC2012", type=str)
    ...
    label_list = voc12.dataloader.load_image_label_list_from_xml(train_val_name_list, args.coco14_root)
