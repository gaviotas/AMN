...
def get_img_path(img_name, voc12_root):
    ...
    return os.path.join(voc12_root, IMG_FOLDER_NAME, 'COCO_train2014_' + img_name + '.jpg')
...
class COCO14SegmentationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {'name': name_str, 'img': img, 'label': label, "label_cls": torch.from_numpy(self.label_list[idx])}
